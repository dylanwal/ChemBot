...
serial_pump_front = chembot.communication.PicoSerial(NamesSerial.PUMP_FRONT, "COM11")
...
# serial_pump_middle = chembot.communication.PicoSerial(NamesSerial.PUMP_MIDDLE, $$$)
...
# )
#
# serial_pump_back = chembot.communication.PicoSerial(NamesSerial.PUMP_FRONT, $$$$)
