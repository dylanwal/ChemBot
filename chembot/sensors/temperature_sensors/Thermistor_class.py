"""
This class is for measuring temperature_sensors with a thermistor and a MCP3008 Analog to Digital converter.
...
class Thermistors:
    ...
    def get_temp(self):
        # Function returns the temperature_sensors in Celsius
...
if __name__ == "__main__":
    """
    Mode 1: Print out temperature_sensors valves for 1 probe
    Mode 2: Print out temperature_sensors valves for n probe
    Mode 3: Print out temperature_sensors valves for n probe and plot
    """
    mode = 3

    try:
        if mode == 1:
            print("Reading a single temperature_sensors. Position 0.")
